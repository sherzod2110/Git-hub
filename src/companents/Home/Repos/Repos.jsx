...
const Repos = () => {
  ...
  return (
    <>
      <div>
        <div class="repos-top w-100 d-flex justify-content-between align-items-start gap-2 pb-3 mt-3">
        ...
        <ul className="repo-list list-unstyled d-flex flex-column gap-2 p-0 m-0 my-3">
          {repos.map((item) => {
            return (
              <li className="repo-item w-100 p-4" key={item.id}>
                <div className="item-top w-100 d-flex justify-content-between align-items-center">
                  <div className="item-top-info d-flex align-items-center gap-3 w-100">
                    <a
                    ...
                    <p className="repo-type2 py-0 px-2 m-0">
                      {item.visibility}
                    </p>
                  </div>
                  <div className="input-group d-flex justify-content-end">
                    <button type="button" className="star-btn fw-normal">
                      <i class="bi bi-star"></i> Star
                    </button>

                    <button
                      type="button"
                      className="dropdown-toggle dropdown-toggle-split erehrh"
